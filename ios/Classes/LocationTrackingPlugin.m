#import "LocationTrackingPlugin.h"
#import <CoreLocation/CoreLocation.h>

@implementation LocationTrackingPlugin {
...
static LocationTrackingPlugin *instance = nil;
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar> *)registrar {
  @synchronized(self) {
    if (instance == nil) {
      instance = [[LocationTrackingPlugin alloc] init:registrar];
...
#pragma mark LocationTrackingPlugin Methods
...
- (instancetype)init:(NSObject<FlutterPluginRegistrar> *)registrar {
  ...
  _headlessEngine = [[FlutterEngine alloc] initWithName:@"io.flutter.plugins.location_tracking"
                                                project:nil];
  _registrar = registrar;

  // This is the method channel used to communicate with the UI Isolate.
  _mainChannel =
      [FlutterMethodChannel methodChannelWithName:@"plugins.flutter.io/location_tracking"
  ...
  _callbackChannel = [FlutterMethodChannel
      methodChannelWithName:@"plugins.flutter.io/location_tracking_callback"
